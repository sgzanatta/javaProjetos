...
public class Program {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= n; i++) {
			...
			System.out.print("Id: ");
			int id = sc.nextInt();
			while (hasId(list, id)) { // Enquanto o id que eu digitei existir na lista, receber a msg que ja existe o
										// id
			...
			list.add(new Employee(id, name, salary)); // list adicionando o construtor
		}
